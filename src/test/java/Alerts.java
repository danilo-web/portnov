...
public class Alerts {
    ...
    public void test001() throws InterruptedException {
        ...
        findFieldTypeAndSubmit();
        System.out.println("typed in field and submitted");
        RejectAlert();
        System.out.println("delcine popup window");
        submitAgain();
        System.out.println("open popup again");
        acceptAlert();
        System.out.println("alert accepted");
        verifyPage();
        System.out.println("correct page verified");
    }
